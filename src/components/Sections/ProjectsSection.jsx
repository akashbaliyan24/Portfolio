...
const ProjectsSection = () => {
    ...
    return <section className={`py-24 px-6 ${isDarkMode ? "bg-gray-950 text-white" : "bg-gray-50 text-gray-900"} relative overflow-hidden`} id='work' ref={sectionRef} >
        {/* Background Elements  */}
        <div className="absolute inset-0 overflow-hidden">
            <div className={`absolute top-20 left-1/4 w-96 rounded-full blur-3xl opacity-5 ${isDarkMode ? "bg-blue-500" : "bg-blue-400"}`}
            />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            className='text-center mb-20'>
                <motion.div variants={itemVariants} className={`text-sm uppercase tracking-widest ${
                    isDarkMode ? "text-gray-500":"text-gray-600"
                } mb-4`}>
                    Featured Work 
                </motion.div>
                <motion.h2 className='text-3xl md:text-5xl font-light mb-6' variants={itemVariants}>
                    Recent 
