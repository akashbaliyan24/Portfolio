...
import Profile_Pic from "../../assets/image/profile_image.png"
            ...
            >
                <div className="absolute inset overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto w-full z-10 mt-20">
                        ...
                        <div className="block lg:hidden">
                            ...
                            >
                                ...
                                {/* Content - Mobile  */}
                                <motion.div variants={textVariants} className={`text-sm uppercase tracking-widest ${isDarkMode ? "text-gray-500" : "text-gray-600"
                                    } mb-4`}>
                                ...
                                >
                                    <motion.button
                                        ...
                                        className='bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300 relative z-0 hover:z-10'
                                    >
                                        View Work
                                    </motion.button>
                                    ...
                                    <motion.button
                                        ...
                                        className={`border ${isDarkMode
                                            ...
                                            } px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300 relative z-0 hover:z-10`}
                                    >
                                        Get in Touch
                                    </motion.button>
                                </motion.div>
                                ...
                                <motion.div variants={itemVariants}
                                    ...
                                    {[
                                        { icon: FiGithub, href: "https://github.com/akashbaliyan24" },
                                        { icon: FiLinkedin, href: "https://www.linkedin.com/in/akash-baliyan-485059240/" },
                                        { icon: Mail, href: "mailto: akashbaliyan24@gmail.com" }
                                    ].map((social, index) => (
                                        <motion.a
                                            key={index}
                                            href={social.href}
                        ...
                        <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                            ...
                            <motion.div initial="hidden"
                                ...
                                <motion.div variants={itemVariants} className='flex gap-6 mb-8 '>
                                    <motion.button whileHover={{ y: -2 }}
                                        whileTap={{ scale: 0.98 }}
                                        onClick={() => scrollToSection("work")} className='bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-full text-sm uppercase tracking-wide font-medium transition-all duration-300 relative z-0 hover:z-10'>
                                        View Work
                                    </motion.button>
                                    <motion.button whileHover={{ y: -2 }}
                                        whileTap={{ scale: 0.98 }}
                                        onClick={() => scrollToSection("contact")} className={`border ${isDarkMode ? "border-gray-700 hover:border-gray-600 text-gray-300" : "border-gray-300 hover:border-gray-400 text-gray-700"
                                            } px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300 relative z-0 hover:z-10`}>
                                        Get in Touch
                                    </motion.button>
                                </motion.div>
                                ...
                                <motion.div variants={itemVariants} className='flex space-x-6 mb-12'>
                                    {[
                                        ...
                                        <motion.a key={index}
                                            href={social.href}
                                            target={social.href.startsWith("mailto:") ? "_self" : "_blank"} whileHover={{ y: -3, scale: 1.1 }} className={`p-3 rounded-full transition-colors ${isDarkMode ? "text-gray-400 hover:text-white hover:bg-gray-800" : "text-gray-600 hover:text-gray-900 hover:bg-gray-200"
                                                }`}>
                                            <social.icon size={20} />
                                        </motion.a>
                                    ))}
                            ...
                            <motion.div initial="hidden" animate="visible"
                                variants={imageVariants} className='flex justify-center'>
                                <div className="relative">
                                    ...
                                    <motion.div variants={itemVariants} className='flex items-center space-x-8 text-xs uppercase tracking-widest absolute -top-16 -left-28'>
                                        ...
                                        <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>Node.JS</span>
                                        <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>.</span>
                                        <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>mongodb</span>
                                        <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>.</span>
                                        <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>Docker</span>
                                    </motion.div>
                                    <motion.div whileHover={{ scale: 1.04 }} className={`w-80 h-96 rounded-3xl overflow-hidden border-4 ${isDarkMode ? "border-gray-800" : "border-gray-300"
                                        } shadow-2xl`}>
                    ...
                    <motion.div animate={{ y: [0, 8, 0] }}
                        transition={{ duration: 2, repeat: Infinity }} className='absolute bottom-8 left-1/2 transform -translate-x-1/2'>
